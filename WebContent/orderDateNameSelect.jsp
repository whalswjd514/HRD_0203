...
<%
	...
	try{
		String sql="select to_char(a.orderDate,'yyyy-mm-dd'),a.productId,b.name,sum(a.orderQty),sum(a.unitprice*a.orderQty) from order0203 a,product0203 b where a.productId=b.productId group by a.orderDate,a.productId,b.name order by a.orderDate,a.productId";
